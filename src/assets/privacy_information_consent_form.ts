...
<body>
  ...
  <p class="ls2 lh6 bs5 ts4"><em class="emphasis">
      < wanted-preonboarding-group-4>('www.assignment.com'이하 'snpLap 기업과제')
  ...
  <p class='sub_p mgt30'><strong>제1조(개인정보의 처리목적)</br></br>
      < wanted-preonboarding-group-4>(이)가 개인정보 보호법 제32조에 따라 등록․공개하는 개인정보파일의 처리목적은 다음과 같습니다.
    </strong></p>
  <ul class='list_indent2 mgt10'>
    <li class='tt'><b>1. 개인정보 파일명 : 프리온보딩4조 컴퍼니</b></li>
    <li>개인정보의 처리목적 : 개인정보동의 확인</li>
    <li>수집방법 : 홈페이지</li>
    <li>보유근거 : 개인정보동의 확인</li>
    <li>보유기간 : 지체없이 파기</li>
...
<head>
  ...
  <p class="sub_p mgt10">② <span class="colorLightBlue">
      < wanted-preonboarding-group-4>
    </span>은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.</p>
  <ul class="list_indent2 mgt10">
    <li class="tt">1. < 프리온보딩4조 관리팀>
    </li>
    <li>개인정보를 제공받는 자 : 프리온보딩4조 관리팀</li>
    <li>제공받는 자의 개인정보 이용목적 : 이메일, 성별, 이름</li>
    <li>제공받는 자의 보유.이용기간: 지체없이 파기</li>
  </ul></br></br>
  <p class='lh6 bs4'><strong>제4조(개인정보의 파기절차 및 파기방법)<em class="emphasis"></strong></p>
  <p class='ls2'></br>① < wanted-preonboarding-group-4> 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를
      파기합니다.</br></br>② 정보주체로부터 동의받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의
      데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.</br>1. 법령 근거 :</br>2. 보존하는 개인정보 항목 : 계좌정보, 거래날짜</br></br>③ 개인정보 파기의 절차 및 방법은
      다음과 같습니다.</br>1. 파기절차</br>
      < wanted-preonboarding-group-4> 은(는) 파기 사유가 발생한 개인정보를 선정하고, < wanted-preonboarding-group-4> 의 개인정보 보호책임자의 승인을 받아
          개인정보를 파기합니다.</br></p>
  ...
  <p class="ls2"><br /><br />① 정보주체는 wanted-preonboarding-group-4에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.</p>
  <p class='sub_p'>② 제1항에 따른 권리 행사는wanted-preonboarding-group-4에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
    통하여 하실 수 있으며 wanted-preonboarding-group-4은(는) 이에 대해 지체 없이 조치하겠습니다.</p>
  ...
  <p class='sub_p'>⑥ wanted-preonboarding-group-4은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
  ...
  <p class="ls2"><br /><br />wanted-preonboarding-group-4 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용하지 않습니다.
  <p class='sub_p mgt30'><strong>제8조 (개인정보 보호책임자에 관한 사항) </strong></p>
  <p class='sub_p mgt10'> ① <span class='colorLightBlue'>wanted-preonboarding-group-4</span> 은(는) 개인정보 처리에 관한 업무를 총괄해서
    책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
  <ul class='list_indent2 mgt10'>
    <li class='tt'>▶ 개인정보 보호책임자 </li>
    <li>성명 :홍길동</li>
    <li>직책 :팀장</li>
    <li>직급 :과장</li>
    <li>연락처 :01012345678, xxxx@gmail.com, 1111</li>
  </ul>
  ...
  <p class='sub_p'>② 정보주체께서는 wanted-preonboarding-group-4 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한
    사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. wanted-preonboarding-group-4 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.</p>
  <p class='sub_p mgt30'><strong>제9조(개인정보의 열람청구를 접수·처리하는 부서)</br> 정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수
      있습니다.<br />
      < wanted-preonboarding-group-4></span>은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
    </strong></p>
  <ul class='list_indent2 mgt10'>
  ...
  <p class='sub_p'>① 이 개인정보처리방침은 2022년 7월 24부터 적용됩니다.</p>
  <p class='sub_p'></p>
  <p class='sub_p'></p>
